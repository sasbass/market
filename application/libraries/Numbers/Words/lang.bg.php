 ...
 */
require_once dirname(__DIR__) . "/Words.php";
 ...
 * @link     http://pear.php.net/package/Numbers_Words
 */
class Numbers_Words_bg extends Words
{
    ...
    var $_currency_names = array(
		...
		'DKK' => array(array('krone', 'kroner'), array('шre')),
		...
		'NOK' => array(array('norsk krone', 'norske kroner'), array('шre')),
		'PLN' => array(array('zloty', 'zlotys'), array('grosz')),
		'SEK' => array(array('svensk krone', 'svenske kroner'), array('шre')),
     ...
     * @access public
     */
    var $def_currency = 'BGN'; // Bulgarian leva
    ...
    function toCurrencyWords($int_curr, $decimal, $fraction = false, $convert_fraction = true)
    {
		...
		//Превод на стотинките
        if (($fraction !== false) and ($fraction != 0)) {
            if ($convert_fraction) {
                $ret .= $this->_sep . trim($this->_toWords($fraction,true));
            } else {
